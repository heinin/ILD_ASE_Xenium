...
# n_pcs = 40, 60, 80
seurat_40 <- readRDS("/scratch/hnatri/ILD/ILD_spatial_ASE/ILDASE_base_PC-40.rds")
seurat_60 <- readRDS("/scratch/hnatri/ILD/ILD_spatial_ASE/ILDASE_base_PC-60.rds")
seurat_80 <- readRDS("/scratch/hnatri/ILD/ILD_spatial_ASE/ILDASE_base_PC-80.rds")
...
rm(seurat_20, seurat_40, seurat_60, seurat_80)
...
#saveRDS(seurat_object, "/tgen_labs/banovich/IPF/Spatial_ASE/ILD_ASE_Xenium_processed.rds")
```
